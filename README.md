...
- You have already installed a ROKS cluster.  You can do this manually, through TechZone or using the [Daffy_RHOCP_Installer](https://ibm.github.io/daffy/).  The remainder of this documentation assumes you have already installed a ROKS cluster using the [Daffy_RHOCP_Installer](https://ibm.github.io/daffy/) but can be easily adapted to the other methods of ROKS installation. 
